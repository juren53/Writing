...
#  updated on Sun 20 Aug 2023 12:13:07 AM CDT  extended to 26 hr time frame
#  updated on Sun 10 Mar 2024 04:52:10 AM CDT  zeros printed as blank spaces
#
#  print("{0:>5}".format("  "), end=' ') if p25 == 0 else print("{0:>5}".format(p25), end=' ')  
#-----------------------------------------------------------
import pandas as pd
import os
import glob
...
# set names for subsequent hours
...
for x in slist:
    ...
    print("{0:>5}".format("  "), end=' ') if p1 == 0 else print("{0:>5}".format(p1), end=' ')
    print("{0:>5}".format("  "), end=' ') if p2 == 0 else print("{0:>5}".format(p2), end=' ')
    print("{0:>5}".format("  "), end=' ') if p3 == 0 else print("{0:>5}".format(p3), end=' ')
    print("{0:>5}".format("  "), end=' ') if p4 == 0 else print("{0:>5}".format(p4), end=' ')
    print("{0:>5}".format("  "), end=' ') if p5 == 0 else print("{0:>5}".format(p5), end=' ')
    print("{0:>5}".format("  "), end=' ') if p6 == 0 else print("{0:>5}".format(p6), end=' ')
    print("{0:>5}".format("  "), end=' ') if p7 == 0 else print("{0:>5}".format(p7), end=' ')
    print("{0:>5}".format("  "), end=' ') if p8 == 0 else print("{0:>5}".format(p8), end=' ')
    print("{0:>5}".format("  "), end=' ') if p9 == 0 else print("{0:>5}".format(p9), end=' ')
    print("{0:>5}".format("  "), end=' ') if p10 == 0 else print("{0:>5}".format(p10), end=' ')
    print("{0:>5}".format("  "), end=' ') if p11 == 0 else print("{0:>5}".format(p11), end=' ')
    print("{0:>5}".format("  "), end=' ') if p12 == 0 else print("{0:>5}".format(p12), end=' ')
    print("{0:>5}".format("  "), end=' ') if p13 == 0 else print("{0:>5}".format(p13), end=' ')
    print("{0:>5}".format("  "), end=' ') if p14 == 0 else print("{0:>5}".format(p14), end=' ')
    print("{0:>5}".format("  "), end=' ') if p15 == 0 else print("{0:>5}".format(p15), end=' ')
    print("{0:>5}".format("  "), end=' ') if p16 == 0 else print("{0:>5}".format(p16), end=' ')
    print("{0:>5}".format("  "), end=' ') if p17 == 0 else print("{0:>5}".format(p17), end=' ')
    print("{0:>5}".format("  "), end=' ') if p18 == 0 else print("{0:>5}".format(p18), end=' ')
    print("{0:>5}".format("  "), end=' ') if p19 == 0 else print("{0:>5}".format(p19), end=' ')
    print("{0:>5}".format("  "), end=' ') if p20 == 0 else print("{0:>5}".format(p20), end=' ')
    print("{0:>5}".format("  "), end=' ') if p21 == 0 else print("{0:>5}".format(p21), end=' ')
    print("{0:>5}".format("  "), end=' ') if p22 == 0 else print("{0:>5}".format(p22), end=' ')
    print("{0:>5}".format("  "), end=' ') if p23 == 0 else print("{0:>5}".format(p23), end=' ')
    print("{0:>5}".format("  "), end=' ') if p24 == 0 else print("{0:>5}".format(p24), end=' ')
    print("{0:>5}".format("  "), end=' ') if p25 == 0 else print("{0:>5}".format(p25), end=' ')

    print("{0:>5}".format("  ")) if p26 == 0 else print("{0:>5}".format(p26))
