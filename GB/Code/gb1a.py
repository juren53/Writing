#!/usr/bin/python3
# gb1a.py   [formerly gb-pack-race.py]
#-----------------------------------------------------------
# Points earned by "pack" member between two dates
# pack pulled from data/list.txt
# last edited on Wed 02 Feb 2022 10:36:36 AM CST - code conversion to python3
